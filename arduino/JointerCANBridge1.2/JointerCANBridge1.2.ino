...
int CANAdressReceiveTable[2][2]={{2305,145}, //{přijatá hodntoa,přeposílaná hodntota} -- to co se má jen přeposílat APU
                                 {2306,146}}; 
int CANAdressSendTable[4][2]={{17,257},//{přijatá hodntoa,přeposílaná hodntota} -- to co se má posílat vESCum
                              {18,258},
