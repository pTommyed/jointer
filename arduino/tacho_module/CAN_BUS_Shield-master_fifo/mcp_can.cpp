...
/* FIFI Rx Buffer defines */
#define fifo_buff_size 256
#define fifo_buff_mask (fifo_buff_size-1)

/* Static Variables */
static volatile int32 fifo_buff[fifo_buff_size];
...
*********************************************************************************************************/
INT8U MCP_CAN::readMsgBuf(INT8U *len,fifo_Head, buf_fifo)
{
  INT8U  rc;
  uint8_t tmphead;
