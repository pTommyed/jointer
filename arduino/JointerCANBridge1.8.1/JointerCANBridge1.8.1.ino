...
/*verze bez bufru příchozích zpráv - překlad tabulka + for cykly - verze na K2*/
...
{
  int resendAdress; //přeposílaná adresa
  byte resendBuf[8]; //buffer přijaté zprávy
  int CountMessge; // počet doručených zpráv
};
