...
int adress_tabel [record_number][5]= {{2305,0,0,0,0}, // vesc 1
                                     {2306,0,0,0,0}, // vesc 2
                                     {2307,1,0,0,0}, // vesc 3 
                                     {2308,1,0,0,0}, // vesc 4
                                     {2309,2,0,0,0}, // vesc 5
...
void CAN_filter_extended_initial(){
  CAN.init_Filt(0, 1, 0x901);  //901
  CAN.init_Filt(1, 1, 0x902);
  CAN.init_Filt(2, 1, 0x903); //903
  CAN.init_Filt(3, 1, 0x904);
  CAN.init_Filt(4, 1, 0x905);
  CAN.init_Filt(5, 1, 0x906);
}
...
void CAN_filter_standard_initial(){
  ...
  CAN.init_Filt(2, 0, 0x72); //903
  CAN.init_Filt(3, 0, 0x81);
  CAN.init_Filt(4, 0, 0x82);
  CAN.init_Filt(5, 0, 0x93);
}
