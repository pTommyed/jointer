// timer1
// DESCRTIPTION: - pouze standard can
...
void CAN_MASK_initial(){
  ...
  CAN.init_Mask(0, 0, 0x3f8); //filtruje extended zprávy a nekomtroluje první dva bajty adresy CAN.init_Mask(0, 1, 0x3ff00);
  CAN.init_Mask(1, 0, 0x3ff); // CAN.init_Mask(0, 1, 0x3ffff) filtruje extended a kontorluje vše
}
...
void CAN_filter_standard_initial(){
  ...
  CAN.init_Filt(0, 0, 0x80); 
  CAN.init_Filt(1, 0, 0x90);
  CAN.init_Filt(2, 0, 0x01);
  CAN.init_Filt(3, 0, 0x01);
  CAN.init_Filt(4, 0, 0x71);
  CAN.init_Filt(5, 0, 0x72);
}
